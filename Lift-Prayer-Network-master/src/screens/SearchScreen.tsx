  ...
  const performSearch = useCallback(async () => {
    ...
    try {
      ...
      if (filters.type === 'all' || filters.type === 'REQUEST') {
        ...
        logFirestoreRead('search_requests', requestSnapshot.size);
      ...
      if (filters.type === 'all' || filters.type === 'TESTIMONY') {
        ...
        logFirestoreRead('search_testimonies', testimonySnapshot.size);
      ...
      setResults(allResults.slice(0, SEARCH_LIMIT));
    } catch (err) {
