...
export const lightPalette = {
  ...
  glassWhite: '#FFFFFF',
  glassWhiteLight: '#FFFFFF',
  glassWhiteStrong: '#FFFFFF',
  glassBorder: '#E6E6E6',
  glassBorderLight: '#F3F3F3',

  cinematicBackground: '#FFFFFF',
  cinematicBackgroundOuter: '#FFFFFF',

  gradientWarm: ['#FFFFFF', '#F9F9F9', '#F3F3F3'] as const,
  gradientSunrise: ['#FFFFFF', '#F9F9F9', '#F3F3F3'] as const,
  gradientCool: ['#FFFFFF', '#F9F9F9', '#E6F4E6'] as const,
  gradientPurple: ['#FFFFFF', '#F9F9F9', '#F3F3F3'] as const,
  gradientSuccess: ['#E6F4E6', '#FFFFFF', '#F9F9F9'] as const,
  screenGradient: ['#FFFFFF', '#F9F9F9', '#F3F3F3'] as const,
  cardGradient: ['#FFFFFF', '#FFFFFF'] as const,

  gradientBoldScreen: ['#FFFFFF', '#F9F9F9', '#F3F3F3', '#F9F9F9', '#FFFFFF'] as const,
  gradientBoldCard: ['#FFFFFF', '#FFFFFF', '#F9F9F9', '#FFFFFF'] as const,
  gradientBoldAccent: ['#1A8917', '#156D14', '#0D4A0C', '#1A8917'] as const,
  gradientBoldHeader: ['#FFFFFF', '#F9F9F9', '#FFFFFF', '#F9F9F9'] as const,
  gradientBoldButton: ['#1A8917', '#156D14', '#0D4A0C'] as const,
